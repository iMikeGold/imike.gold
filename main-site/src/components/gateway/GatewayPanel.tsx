...
export function GatewayPanel({
  ...
  function handleClick(event: MouseEvent<HTMLAnchorElement>) {
    ...
    // First tap opens a mobile glimpse. Second tap enters the destination.
      ...
      >
        ...
        <div className="gateway-status" aria-hidden="true">
          <span
            ...
            data-playing={isActive && !!gateway.videoSrc}
          />
          {feedStatus}
        </div>
      </a>
  ...
  useEffect(() => {
    ...
    if (active) {
      void video.play().catch(() => {
        // The destination remains usable if a browser blocks playback.
      });
      return;
    }
